...
Usage:
    ./model.py -e 24 -w </path/to/data> -r 0 -z 64
"""
...
tain = EegLoader(data_dir, subj, args.validate_mode, training=True)
test = EegLoader(data_dir, subj, args.validate_mode, training=False)
...
if args.validate_mode:
    preds_name = 'eval.'
    idx_file = os.path.join(data_dir, 'eval-' + str(subj) + '-0-index.csv')
